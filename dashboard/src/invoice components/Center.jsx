...
function Center() {
    ...
    return (
        <div>
            <div className='dark:bg-[#141625] scrollbar-hide duration-300 min-h-screen bg-[#f8f8fb] py-[34px] px-2 md:px-8 lg:px-4 lg:py-4  '>
                ...
                <motion.div
                    ...
                    <div className='w-full max-h-[64px] flex items-center justify-between'>
                        <div>
